...
int main(){
    ...
    MatrixXd trainingData = readCoulomb("/home/dabadie/phd/atomicLearning/PRL2012/cpp/data/trainingSplit/coulomb_train.txt");
    VectorXd trainingTrgt = readPBE0   ("/home/dabadie/phd/atomicLearning/PRL2012/cpp/data/trainingSplit/PBE0_train.txt");

    MatrixXd testingData  = readCoulomb("/home/dabadie/phd/atomicLearning/PRL2012/cpp/data/trainingSplit/coulomb_test.txt");
    VectorXd testingTrgt  = readPBE0   ("/home/dabadie/phd/atomicLearning/PRL2012/cpp/data/trainingSplit/PBE0_test.txt");
    ...
    std::ofstream file2("energies.txt");
    if (file2.is_open()){
        file2 << PBE << std::endl;
        file2 << est << std::endl;
