...
Z_small, R_small, E_small = importQM7(structure_file = "data/sizeSplit/qm7_small.txt", 
                                      energy_file    = "data/sizeSplit/PBE0_small.txt")
Z_rest,  R_rest,  E_rest  = importQM7(structure_file = "data/sizeSplit/qm7_rest.txt", 
                                      energy_file    = "data/sizeSplit/PBE0_rest.txt")
...
training_data = coulomb_eigenvalues(Z=Z_train, R=R_train, n_max=n_max, outputname="data/trainingSplit/coulomb_train.txt")
training_trgt = np.array(E_train)
np.savetxt(fname="data/trainingSplit/PBE0_train.txt", X=training_trgt)
print(np.shape(training_data))
print(np.shape(training_trgt))

testing_data  = coulomb_eigenvalues(Z=Z_test, R=R_test, n_max=n_max, outputname="data/trainingSplit/coulomb_test.txt")
testing_trgt  = np.array(E_test)

print(np.shape(testing_data))
print(np.shape(testing_trgt))

np.savetxt(fname="data/trainingSplit/PBE0_test.txt", X=testing_trgt)